var express = require('express')
  ...
  , api = express.Router()
  , omxcontrol = require('simpleomxcontrol')
...
app.render('list.pug', function () {
  console.log("Compiled list.pug");
  app.render('current.pug', function () {
    console.log("Compiled current.pug");
