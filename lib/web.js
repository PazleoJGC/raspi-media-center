...
web.shutdown = function (req, res) {
  return res.render('shutdown.pug');
}

web.shutdownConfirm = function (req, res) {
  res.render('shutdownConfirm.pug');
